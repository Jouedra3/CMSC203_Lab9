...
//Demonstrating the BankAccount and derived classes
public class AccountDriver {
        public static void main(String[] args) {
        		...
        		// getytting 2 decimals every time
                myFormat = new DecimalFormat("#.00");

        		//testing the Checking Account class
        		...
        		//testing the savings account class
        		...
        		//testing the copy constructor of the savings account class
